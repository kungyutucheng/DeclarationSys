...
<body class="easyui-layout">
	<div data-options="region:'north',split:true,title:'查询条件'" style="height:200px;">
		<form id="searchForm" method="POST">
			<table class="myTable">
				...
				<tr>
					<td>异常代码</td>
					<td colspan="2">
						<input class="easyui-textbox" name="ecode" style="width:100%;">
					</td>
				</tr>
				<tr>
					<td>创建时间</td>
	...
	$(function(){
		$("#dg").datagrid({
			url:"${basePath}/exceptionLog/searchgrid",
			...
			columns:[[
			          ...
			          {field:"ecode",title:"异常代码",width:300},
			          {field:"detail",title:"详情",width:300},
			          {field:"params",title:"参数",width:500},
